...
const Table = ({
  ...
  const columnNameToProperty = {
    ...
    "Weight(lb)": "warehouseReceiptObj.weight",
    "Volume(ft3)": "warehouseReceiptObj.volumen",
    " Volume (ft3)": "volumen",
    Note: "note",
  ...
  const getHazardStatus = (row) => {
    console.log("EJECUTANDO HAZARD STATUS", row)
    if (row && row.commodities) {
      return row.commodities.some((com) => com.hazardous) ? <i className="fas fa-check"></i> :
                      ...
                      {columnOrder.map((columnName) =>
                          visibleColumns[columnName] ? (
                              ...
                              >
                                ...
                                ) : columnName === "Contains hazards" ? (getHazardStatus(row)) : columnNameToProperty[columnName]?.includes(
                                    "."
                                ) ? (
                                    getPropertyValue(
                                        row,
